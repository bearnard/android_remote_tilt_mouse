...
import com.michalsznajder.android.master.accrawgravity.R;
...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    // Bluetooth - rozwi¹zania zaproponowane przez dokumentacjê systemu Android
	@Override
...
// Touchpad
	...
	public void onSensorChanged(SensorEvent event) { 
				...
				int moveXFinal = Math.round(event.values[0]);
				int moveYFinal = Math.round(event.values[1]);			
				if (moveXFinal != 0 || moveYFinal != 0)
				{
					sendMovePacket(MESSAGE_MOVE_ACC_GRAVITY, moveXFinal, moveYFinal);
